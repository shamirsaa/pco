<template>
  <div class="main-content">
    ...
    <!-- <div class="card">
      ...
      <div class="card-body">
        ...
        >
          ...
          <table-column show="songs"      label="Songs"     data-type="numeric" />
    ...
    <div class="card">
      ...
      <div class="card-body">
        <table-component :data="fetchData" table-class="table"  sort-by="username" sort-order="asc">
          <table-column show="username" label="username"   />
          <table-column show="cerrados" label="cerrados" />
          <table-column show="cumplimiento" label="cumplimiento" :sortable="false" :filterable="false"/>
          <table-column show="updated_at" label="Actualizado"/>
          <table-column :sortable="false" :filterable="false" label="" >

            <template slot-scope="row">
              <div class="table__actions">
                <a :href="`#${row.username}`">View</a>
                <!-- <a :href="`#${row.username}`">Edit</a>
                <a :href="`#${row.username}`">Delete</a> -->
              </div>
            </template>
          </table-column>
        </table-component>
